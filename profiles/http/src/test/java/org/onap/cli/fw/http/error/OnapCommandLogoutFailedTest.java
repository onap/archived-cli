...
public class OnapCommandLogoutFailedTest {
    ...
    @Test
    public void oclipCommandLogoutFailedTest2() {
        OnapCommandLogoutFailed failed = new OnapCommandLogoutFailed("Failed");
        assertEquals("0x4002::Logout failed, Failed", failed.getMessage());
    ...
    @Test
    public void oclipCommandLogoutFailedTest3() {
        OnapCommandLogoutFailed failed = new OnapCommandLogoutFailed("Failed");
        assertEquals("0x4002::Logout failed, Failed", failed.getMessage());
