        ...
        if (cmd.getService() != null) {
            ...
            if (noAuth) {
                if (cmd.isCommandInternal()) {
                    ...
                    includeAuthParams.addAll(OnapCommandConfg.getRequiredAuthParamsForExternalCmd());
                    excludeAuthParams.addAll(OnapCommandConfg.getExcludeAuthParamsForAuthDisabledExternalCmd());
                }
