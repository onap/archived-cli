        ...
        for (String key : sections) {
            ...
            if (Constants.NAME.equals(key)) {
                ...
                if (defParamsFromDefPFile.isEmpty() && defParameters != null) {
                    throw new OnapCommandInvalidDefaultParameter("default parameters are not applicable");
                }
                ...
                if (defParameters != null) {
                    ...
                    if (includeParams != null) {
                        ...
                        if (!invInclude.isEmpty()) {
                            throw new OnapCommandInvalidDefaultParameter("invalid include" + invInclude.toString());
                        }
                    }
                    ...
                    if (excludeParams != null) {
                        ...
                        if (!invExclude.isEmpty()) {
                            throw new OnapCommandInvalidDefaultParameter("invalid include" + invExclude.toString());
                        }
                    }
