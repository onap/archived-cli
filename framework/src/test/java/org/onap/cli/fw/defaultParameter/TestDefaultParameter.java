...
public class TestDefaultParameter {
    ...
    @Test(expected = OnapCommandInvalidDefaultParameter.class)
    public void checkDefaultEnabledDisableDefaultParamsPresent() throws OnapCommandException {
        OnapCommand cmd = new OnapCommand() {
            @Override
            protected void run() throws OnapCommandException {}
        };

        OnapCommandUtils.loadSchema(cmd, "sample-test-import-def-param-false.yaml", false);
    }
}
