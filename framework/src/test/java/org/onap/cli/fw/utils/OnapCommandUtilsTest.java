...
public class OnapCommandUtilsTest {
    ...
    @OnapCommandSchema(name = "sample-test", version = "1.0", schema = "sample-test-schema.yaml")
    ...
    @OnapCommandSchema(name = "sample-swagger-test", version = "1.0", schema = "sample-test-schema-swagger.yaml")
    ...
    @OnapCommandSchema(name = "sample-http-test", version = "1.0", schema = "sample-test-schema-http.yaml")
