...
public class OpenInterfaceGrpcServerTest {
    ...
    public void multiInputArgs() throws IOException, InterruptedException{
        ...
        OpenInterfaceGrpcServer.OpenRemoteCli openRemoteCli = new OpenInterfaceGrpcServer.OpenRemoteCli(args);
        openRemoteCli.setArgs(args);
        Assert.assertEquals("",openRemoteCli.getResult());
    }
